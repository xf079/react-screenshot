...
export interface IShapeCircleProps extends ShapeBaseProps {
  shape: IShapeType;
}

export const ShapeCircle: FC<IShapeCircleProps> = ({
  shape,
  selected,
  updateSelected,
  updateMode,
  ...
  return (
    <Fragment>
      <Ellipse
        ...
        offsetX={-(rectState.width / 2)}
        offsetY={-(rectState.height / 2)}
